...
export function Navbar({
  ...
  return (
    <nav className="sticky top-0 z-40 w-full border-b border-border/40 bg-background/60 backdrop-blur-2xl">
        ...
        <div className="flex items-center gap-5">
          <div className="hidden sm:flex items-center gap-3 px-4 py-1.5 rounded-full border border-border/50 bg-background/50">
            ...
            <div className="flex flex-col">
              ...
              <span
                className={`text-[9px] font-bold uppercase tracking-widest mt-0.5 ${role === "admin" ? "text-primary" : "text-muted-foreground"}`}
              >
